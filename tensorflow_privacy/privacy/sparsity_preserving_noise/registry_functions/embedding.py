...
def embedding_layer_contribution_histogram(
...
) -> type_aliases.ContributionCountHistogramFn:
  ...
  Returns:
    A function with signature `(tf.IndexedSlices) -> tf.SparseTensor`. The
    function takes a `tf.IndexedSlices` object representing the gradient and
