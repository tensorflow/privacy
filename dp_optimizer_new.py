...
def make_laplace_optimizer_class(cls):
  ...
  class DPLaplaceOptimizerClass(make_optimizer_class(cls)):  # pylint: disable=empty-docstring
    ...
    def __init__(
      ...
      dp_sum_query = laplace_query.LaplaceSumQuery(
          l2_norm_clip, l2_norm_clip * noise_multiplier)

      super(DPLaplaceOptimizerClass,
            self).__init__(dp_sum_query, num_microbatches, unroll_microbatches,
                           *args, **kwargs)
...
def make_cactus_optimizer_class(cls):
  
  class DPCactusOptimizerClass(make_optimizer_class(cls)):  # pylint: disable=empty-docstring
    ...
    def __init__(
      ...
      dp_sum_query = cactus_query.CactusSumQuery(
          l2_norm_clip, l2_norm_clip * noise_multiplier)

      super(DPCactusOptimizerClass,
            self).__init__(dp_sum_query, num_microbatches, unroll_microbatches,
                           *args, **kwargs)
...
DPGradientDescentLaplaceOptimizer = make_laplace_optimizer_class(
    GradientDescentOptimizer)

DPGradientDescentCactusOptimizer = make_cactus_optimizer_class(
    GradientDescentOptimizer)
